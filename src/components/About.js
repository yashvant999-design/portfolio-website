        ...
        <div className='container'>
            <div id='aboutrow' style={{justifyContent:'center'}} className='row'>
                <div id='aboutmain' className='col-lg-5'>
                    ...
                    <img id='aboutimg1' style={{Width:'500px'}} src={a1} alt="about1"/>
                    </div>
                    <div className="col-lg-6">
                    <img id='aboutimg2' style={{marginTop:'20px',Width:'500px'}} src={a2} alt="about2"/>
                    </div>
                </div>

                <div className='col-lg-7'>
                    <div className='hero-image'>
                            <img id='aboutimg3' style={{height:'510px',width:'100%'}} src={a3} alt="about3"/>                       
